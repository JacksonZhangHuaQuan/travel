...
public class Strategy {
    ...
    public Strategy(int strategy_id, int user_id, String strategy_title, String strategy_firstimg, Date strategy_date, int strategy_days, String strategy_address, int strategy_money, String strategy_type, String strategy_season, String strategy_describe, String strategy_photos, String strategy_status, int strategy_score) {
    ...
    //插入语攻略
    public Strategy(int user_id, String strategy_title, String strategy_firstimg, Date strategy_date, int strategy_days, String strategy_address, int strategy_money, String strategy_type, String strategy_season, String strategy_describe, String strategy_photos, int strategy_score) {
        this.user_id = user_id;
        this.strategy_title = strategy_title;
        this.strategy_firstimg = strategy_firstimg;
        this.strategy_date= strategy_date;
    ...
    //删除攻略
    public Strategy(int strategy_id, String strategy_title, String strategy_firstimg, Date strategy_date, int strategy_days, String strategy_address, int strategy_money,  String strategy_describe, String strategy_photos) {
        this.strategy_id = strategy_id;
        this.strategy_title = strategy_title;
        this.strategy_firstimg = strategy_firstimg;
        this.strategy_date= strategy_date;
